...
export const Navbar = ({ children }) => {
  return (
    <div className=" font-sans bg-primary h-screen sm:px-0 lg:px-40 lg:w-screen w-max sm:w-max pt-16">
      <div className="flex justify-between w-full h-5/6">
        <div className="flex flex-col justify-between h-full items-begin">
        ...
        <div className="flex flex-col justify-between  h-full w-2/5  ">
          ...
          <div className="flex flex-col justify-around h-3/5">
            ...
            <span className="text-inverted text-md">
              {" "}
              Young and passionate about everything tech and code, I am eager to
              learn on a daily basis. What I love the most is making an idea
              come true, so if you have any projects, don't hesitate to contact
              me.
            </span>
          </div>
        </div>
